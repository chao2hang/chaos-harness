...
export const en = {
  ...
  modelAdvanced: 'Capabilities and limits',
  modelImageInput: 'Accept image uploads',
  modelImageInputHint: 'Enabled for new custom models. Turn it off when this endpoint accepts text only.',
  modelReasoning: 'Reasoning effort levels',
  modelReasoningNone: 'Not adjustable',
  modelReasoningStandard: 'Standard levels',
  modelReasoningDeepSeek: 'DeepSeek levels',
  modelReasoningHint: 'The model selector offers only these levels. Requests use the matching reasoning_effort value.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '能力与容量',
  modelImageInput: '支持上传图片',
  modelImageInputHint: '新建自定义模型默认开启；若接口只接受文本，请关闭。',
  modelReasoning: '推理强度档位',
  modelReasoningNone: '不可调节',
  modelReasoningStandard: '标准档位',
  modelReasoningDeepSeek: 'DeepSeek 档位',
  modelReasoningHint: '模型选择器只显示这里启用的档位，请求会发送对应的 reasoning_effort 值。',
  addModel: '添加模型',
  removeModel: '删除模型',
