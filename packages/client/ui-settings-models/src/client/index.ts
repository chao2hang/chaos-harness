/**
 * Models settings and DeepSeek credential-onboarding plugin, browser half. It
 * registers the Models page and the conditional official-DeepSeek onboarding
 * dialog. The Host settings and credential contracts stay behind their
 * existing wire APIs. Export discipline: packages/client/AGENTS.md.
 */
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    /** The Models page + credential-onboarding copy. */
