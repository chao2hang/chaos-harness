...
export const zh = {
  ...
  'stats.title': '会话统计与性能',
  'stats.section.counts': '执行轮次与步骤',
  'stats.section.durations': '耗时分布',
  'stats.section.performance': '响应性能',
  'stats.section.tokens': 'Token 与缓存消耗',
  'stats.counts': '{turns} 轮 · {steps} 步',
  'stats.llm': 'LLM {duration}',
  'stats.toolCall': '工具调用 {duration}',
  'stats.ttftAverage': '首 token 平均 {duration}',
  'stats.tokensPerSecond': '{throughput} tok/s',
  'stats.averageSpeed': '平均生成速率',
...
export const en = {
  ...
  'stats.title': 'Session Stats & Performance',
  'stats.section.counts': 'Execution Counts',
  'stats.section.durations': 'Durations',
  'stats.section.performance': 'Performance',
  'stats.section.tokens': 'Tokens & Cache',
