...
| [`webserver/`](webserver/README.md) | HTTP/HTTPS route carrier | `ctx.webServer` |
| [`web-auth/`](web-auth/README.md) | Token login and in-memory browser sessions | consumes `ctx.credentials`, `ctx.webServer` |
