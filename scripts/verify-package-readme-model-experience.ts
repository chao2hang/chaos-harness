...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-maintenance': { kind: 'none', reason: 'Browser-side deployment-status projection and process-restart control; registers nothing model-facing.' },
  ...
  'packages/host/web-auth': { kind: 'none', reason: 'The browser transport guard and login routes do not register model-facing content.' },
